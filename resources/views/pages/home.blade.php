...
<!--<button type="button" onclick="displayCookies()">Display All Cookies</button>-->
  ...
  <br><img src="https://alumni.crg.eu/sites/default/files/default_images/default-picture_0_0.png" class="img-fluid">
  <p>Praesent at rhoncus dui. Nunc scelerisque efficitur augue vitae tincidunt. Curabitur bibendum, erat eget accumsan mollis, ex diam convallis est, non lobortis arcu elit quis leo. Nullam sit amet arcu auctor, ornare dui sed, porta sem. Donec quam turpis, pulvinar sed laoreet non, mattis non magna. Nullam leo augue, congue sollicitudin tempus sed, dignissim sed sem. In varius sem in erat scelerisque, et euismod orci condimentum. Etiam laoreet fringilla risus, ac maximus leo tristique vitae.</p>
  <br><img src="https://alumni.crg.eu/sites/default/files/default_images/default-picture_0_0.png" class="img-fluid">
  <p>Vivamus ullamcorper consectetur commodo. Suspendisse accumsan suscipit aliquam. Sed vitae massa a nisl dignissim mattis auctor sit amet sem. Pellentesque id sollicitudin dolor. Nunc ac tellus at velit gravida luctus. Vestibulum tristique dolor magna, efficitur elementum odio condimentum quis. Pellentesque eleifend a mi id semper. Suspendisse at fringilla felis, eu pharetra tortor. Nulla facilisi. Vivamus vehicula imperdiet purus, et accumsan eros lacinia non. Vivamus erat metus, mattis sed vulputate cursus, tristique a turpis. Mauris metus mi, cursus in urna vitae, egestas sagittis nulla. Nam malesuada urna placerat, lobortis lorem in, hendrerit augue. Maecenas metus ligula, scelerisque et ipsum ac, volutpat porttitor justo.</p>
  <br><img src="https://alumni.crg.eu/sites/default/files/default_images/default-picture_0_0.png" class="img-fluid">
