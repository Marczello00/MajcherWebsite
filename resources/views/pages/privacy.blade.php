...
<article class="text-light">
    ...
    <ul>
        <li>
            <p><strong>Serwis</strong> - serwis internetowy "oponymajcher.pl" działający pod adresem https://oponymajcher.pl/</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma ""Majcher" Marian Majcher", prowadząca działalność pod adresem: Pawłosiów 4c, 37-500 Jarosław, o nadanym numerze identyfikacji podatkowej (NIP): 7921775277, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Kontrola plików Cookie</strong>
                <ul>
                    ...
                    <li>
                        <p>Informacje o sposobie wyłączenia plików Cookie w najpopularniejszych przeglądarkach komputerowych dostępne są na stronie: <a rel="external" href="https://nety.pl/jak-wylaczyc-pliki-cookie/">jak wyłączyć cookie</a> lub u jednego ze wskazanych dostawców:<ul>
    ...
    <ul>
        <li>Realizacji usług elektronicznych:<ul></ul>
        </li>
    ...
    <ul>
        <li>
            <p><strong>Prawo dostępu do danych osobowych</strong>
                <br />Użytkownikom przysługuje prawo uzyskania dostępu do swoich danych osobowych, realizowane na żądanie złożone do Administratora</p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p><strong>Adres pocztowy</strong> - "Majcher" Marian Majcher, Pawłosiów 4c, 37-500 Jarosław</p>
        </li>
        <li>
            <p><strong>Adres poczty elektronicznej</strong> - admin@oponymajcher.pl</p>
        </li>
        <li>
